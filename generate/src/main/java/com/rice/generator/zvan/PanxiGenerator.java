 ...
 **/
public class PanxiGenerator extends BaseGenerator {
    ...
    public static InjectionConfig setInjectionConfig() {
        InjectionConfig cfg = new InjectionConfig()
        {
            ...
            public void initMap() {
                ...
                if(StringUtils.isNotEmpty(TableConfig.idType)&&"UUID".equals(TableConfig.idType.toUpperCase())){
                    map.put("idType","UUID");
                    map.put("idValue", UUID.randomUUID().toString().replaceAll("-","").replaceFirst(".",""));
                }else{
                    map.put("idType","AUTO");
                }
                this.setMap(map);
        ...
        focList.add(new FileOutConfig(templatePath + ClassConfig.apiName + ".vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return baseClassPath + ClassConfig.apiPath + tableInfo.getEntityName() + "Api.java";
            }
        });
...
//            }
//        });
//        focList.add(new FileOutConfig(templatePath + ClassConfig.daoName + ".vm") {
//            @Override
//            public String outputFile(TableInfo tableInfo) {
//                return baseClassPath + ClassConfig.daoPath
//                        + tableInfo.getEntityName() + ClassConfig.daoName;
//            }
//        });
